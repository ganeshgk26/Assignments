...
console.log("After the line of Post Increment:"+ (a));
console.log("Pre Increment :" + (++b));
console.log("Post Decrement:"+ (a--));
console.log("After the line of Post Decrement:"+ (a));
...
let c: number = 20;
c += 10;
console.log("Additional Assignment :"+ c);
c -= 5;
console.log("Substraction Assignmnet :" + c);
c *= 2;
