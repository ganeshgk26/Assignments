...
let name1: string = "Ganesh"; //double quotes
let name2: string = 'Ganesh'; //single quotes
let name3: string = `Ganesh`; //backticks
...
interface product {
    ...
    eligibleForRetrun:boolean;
}
let productDetails : product={
    productNmae: "Iphone",
    productPrice: 70000,
    [countryOfOrigin]: "USA",
    eligibleForRetrun: true

}
console.log("productDetails:"+ productDetails.productNmae);
console.log("productDetails:"+ productDetails.productPrice);
